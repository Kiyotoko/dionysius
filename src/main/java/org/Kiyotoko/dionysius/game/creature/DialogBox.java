...
public class DialogBox extends VBox {
    ...
    public static class Dialog implements Serializable {
        ...
        private transient @Nonnull BiConsumer<Dialog, Player> onAction = (d, h) -> { };
        ...
        public void setOnAction(@Nonnull BiConsumer<Dialog, Player> onAction) {
            this.onAction = onAction;
        }

        @Nonnull
        public BiConsumer<Dialog, Player> getOnAction() {
            return onAction;
        }
    ...
    public void next(Player hero, int index) {
        Dialog curr = getCurrent();
